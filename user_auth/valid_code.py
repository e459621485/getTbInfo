...
class ValidCodeImg:
    def __init__(self, width=100, height=38, code_count=4, font_size=35, point_count=20, line_count=3,
                 img_format='png'):
        '''
    ...
    def getValidCodeImg(self):
        ...
        font_path = os.path.join(root_path, r"static\font\KumoFont.ttf")
        print(font_path)
        ...
        for i in range(self.code_count):
            ...
            draw.text((i * 25, -1), random_char, self.getRandomColor(), font=font)
